...
public partial class MydbContext : DbContext
{
    ...
    public virtual DbSet<Flor> Flor { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Idflor).HasName("PRIMARY");
        ...
        modelBuilder.Entity<Producto>(entity =>
        {
            ...
            entity.HasIndex(e => e.Id, "Id_Categoria_FK_idx");

            entity.Property(e => e.Descripcion).HasMaxLength(45);
            entity.Property(e => e.Id).HasColumnName("Id_Categoria");

            entity.HasOne(d => d.IdNavigation).WithMany(p => p.Producto)
